...
static const LangEntry dict_en[] = {
...
static const LangEntry dict_ko[] = {
    {"                    このヘルプ\\n", "                    도움말\\n"},
    {"コマンド:\\n", "명령어:\\n"},
    {"使い方:\\n", "사용법:\\n"},
    {"例:\\n", "예시:\\n"},
...
static const LangEntry dict_zh_cn[] = {
    {"                    このヘルプ\\n", "                    此帮助\\n"},
    {"コマンド:\\n", "命令:\\n"},
    {"使い方:\\n", "用法:\\n"},
    {"例:\\n", "示例:\\n"},
...
static const LangEntry dict_zh_tw[] = {
    {"                    このヘルプ\\n", "                    此幫助\\n"},
    {"コマンド:\\n", "指令:\\n"},
    {"使い方:\\n", "用法:\\n"},
    {"例:\\n", "範例:\\n"},
...
static const LangEntry *current_dict = NULL;
